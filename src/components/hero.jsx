...
const Hero = () => {
  ...
  {/* View Work now scrolls to the #projects section */}
  <motion.a 
    href="#projects"
  ...
  <div className="flex items-center gap-3 ml-2">
    ...
    />
        ...
        >
          <div className="relative z-10 bg-slate-900/50 border border-slate-800 p-8 rounded-3xl backdrop-blur-xl">
...
</p>              <p className="pl-4 text-gray-300">passionate: <span className="text-blue-400">true</span></p>
              <p className="text-blue-400">{"}"};</p>
            </code>
          </div>
          {/* Animated Glow behind the code block */}
...
const SocialIcon = ({ icon, link }) => (
  <motion.a
    ...
    rel="noopener noreferrer"  /* This is a security requirement when using target="_blank" */
    whileHover={{ y: -3, color: '#3B82F6' }}
    className="p-3 bg-slate-900 border border-slate-800 rounded-lg text-gray-400 transition-colors cursor-none"
  >
    {icon}
  </motion.a>
);
